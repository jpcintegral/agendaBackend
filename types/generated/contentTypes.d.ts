...
export interface ApiAreaArea extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u00C1reas involucradas en los eventos';
    displayName: 'Area';
    pluralName: 'areas';
    singularName: 'area';
  };
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Eventos de la agenda pol\u00EDtica';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
  ...
  attributes: {
    ...
    estimatedBudget: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::event.event'> &
      Schema.Attribute.Private;
    needsBudget: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
    startDateTime: Schema.Attribute.DateTime & Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<
      ['pendiente', 'aprobado', 'cancelado', 'considerando']
    > &
